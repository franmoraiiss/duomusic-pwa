...
// O Cravo e a Rosa in C Major
const song: Note[] = [
  { key: MidiNumbers.fromNote('C4'), duration: 500 }, // O
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // cra-
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // vo
  { key: MidiNumbers.fromNote('F4'), duration: 500 }, // bri-
  { key: MidiNumbers.fromNote('G4'), duration: 1000 }, // gou
  { key: MidiNumbers.fromNote('C4'), duration: 500 }, // com
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // a
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // ro-
  { key: MidiNumbers.fromNote('F4'), duration: 500 }, // sa
  { key: MidiNumbers.fromNote('G4'), duration: 1000 }, // De-
  { key: MidiNumbers.fromNote('F4'), duration: 500 }, // bai-
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // xo
  { key: MidiNumbers.fromNote('D4'), duration: 500 }, // du-
  { key: MidiNumbers.fromNote('C4'), duration: 1000 }, // ma
  { key: MidiNumbers.fromNote('G4'), duration: 500 }, // sa-
  { key: MidiNumbers.fromNote('G4'), duration: 500 }, // cá-
  { key: MidiNumbers.fromNote('F4'), duration: 500 }, // da
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // O
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // cra-
  { key: MidiNumbers.fromNote('D4'), duration: 500 }, // vo
  { key: MidiNumbers.fromNote('F4'), duration: 500 }, // sá-
  { key: MidiNumbers.fromNote('E4'), duration: 500 }, // iu
  { key: MidiNumbers.fromNote('D4'), duration: 500 }, // ma-
  { key: MidiNumbers.fromNote('C4'), duration: 1000 }, // chu-
  { key: MidiNumbers.fromNote('C4'), duration: 1000 }, // cá-
  { key: MidiNumbers.fromNote('C4'), duration: 1000 }, // do
];
...
const CravoRosa = () => {
  ...
  const handleNotePlay = (midiNumber: number) => {
    ...
    if (newSequence.length === song.length) {
      ...
      if (!completed.includes('song3')) {
        completed.push('song3');
        ...
        >
          ...
          >
            ...
            <Text fontSize="lg" color="#2D0C57">
              Você completou "O Cravo e a Rosa" com sucesso! 🌹
            </Text>
          </Box>
        </Box>
      )}
